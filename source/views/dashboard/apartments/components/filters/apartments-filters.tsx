...
export default function ApartmentsFilters({ table, id, inputRef, selectedStatuses, handleStatusChange, uniqueStatusValues, statusCounts, handleDeleteRows }: ApartmentsFiltersProps) {
  return (
       ...
       <div className="flex flex-wrap items-center gap-3">
         ...
         {/* Filter by status */}
         <StatusFilter selectedStatuses={selectedStatuses} uniqueStatusValues={uniqueStatusValues} handleStatusChange={handleStatusChange} id={id} statusCounts={statusCounts} />
